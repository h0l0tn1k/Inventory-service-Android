...
import com.sap.grc.riskframework.repository.RiskTemplateRepository;
...
/**
 * REST controller for managing {@link com.sap.grc.riskframework.domain.RiskTemplate}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RiskTemplateResource {
    ...
    private static final String ENTITY_NAME = "riskTemplate";
