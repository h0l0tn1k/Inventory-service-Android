...
export const RiskDeleteDialog = (props: IRiskDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="riskFrameworkApp.risk.delete.question">
        <Translate contentKey="riskFrameworkApp.risk.delete.question" interpolate={{ id: riskEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-risk" color="danger" onClick={confirmDelete}>
